...
.. _README: https://github.com/dimatura/voxnet/blob/master/README.md

License
=======
``voxnet`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/dimatura/voxnet"
DOWNLOAD_URL = ""
LICENSE = "MIT"
...
PACKAGES = ['voxnet',
            'voxnet.tests']
PACKAGE_DATA = {'voxnet': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
